...
const BuildingDorm = ({ activeTab }) => {
  ...
  const fetchData = async (specificDate) => {
    try {
      ...
      await fetchDataForLocation("DormRight", start, end, "Dorm", setRightData);
      await fetchDataForLocation("DormLeft", start, end, "Dorm", setLeftData);
    } catch (error) {
        ...
        <div className="main">
          ...
          <main className="content px-3 py-2 bg-secondary bg-opacity-10">
            <div className="container-fluid">
              <div className="mb-3">
                <h1 className="fw-bold">Alumni Dormitory</h1>
